    ...
    val pages: List<Page> = listOf(
        ...
        Page(
            ...
            markdown = """
                ...
                **Create Your Own Story → Chapter One plan → Verify Your
                Story → Chapter One**. The AI takes part in three of the
                four — it suggests answers, drafts the plan, then writes the
