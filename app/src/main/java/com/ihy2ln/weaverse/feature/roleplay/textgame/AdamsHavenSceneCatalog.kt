...
fun adamsHavenSceneCatalog(): List<TextGameSceneAsset> = buildList {
    ...
    add(scene("farm-unmaintained", listOf("farm", "tycoon"), "farm/unmaintained-ground.png", 1254, 1254))
    ...
    ).forEach { (id, path) -> add(scene("town-$id", listOf("town", "tycoon"), path, 1254, 1254)) }
